     ...
     return (
         <form onSubmit={handleSubmit(onSubmit)}>
             ...
             <label>Trade Ref
                 <input
                     {...register('tradeRef', {
                         ...
                         pattern: {
                             value: /^TRD-\d{4}-\d{4}$/,
                             message: 'format TRD-YYYY-####'
                         }
                     })}
                 />
                 {errors.tradeRef &&
                     <span className="field-error">{errors.tradeRef.message}</span>}
             </label>
             ...
             <label>Instrument ID
                 ...
                 />
                 {errors.instrumentId &&
                     <span className="field-error">{errors.instrumentId.message}</span>}
             </label>
             ...
             <label>Counterparty ID
                 ...
                 {errors.counterpartyId &&
                     <span className="field-error">{errors.counterpartyId.message}</span>}
             </label>
             ...
             <label>Trade Date
                 ...
                 />
                 {errors.tradeDate &&
                     <span className="field-error">{errors.tradeDate.message}</span>}
             </label>
 
             {errors.root?.serverError && (
                 <div className="error">
                     Server: {errors.root.serverError.message}
                 </div>
             )}
