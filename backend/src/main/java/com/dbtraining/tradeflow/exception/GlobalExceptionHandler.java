...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorEnvelope> handleTradeValidation(
    ...
    public ResponseEntity<ErrorEnvelope> handleDataIntegrity(
        ...
        return build(
                HttpStatus.CONFLICT,
                "DATA_CONFLICT",
                "Unique constraint or referential integrity violation",
                null,
                req
        );
    }
    ...
    public ResponseEntity<ErrorEnvelope> handleIllegalState(
    ...
    private static ResponseEntity<ErrorEnvelope> build(
            HttpStatus status,
            String code,
            String message,
            Map<String, String> details,
